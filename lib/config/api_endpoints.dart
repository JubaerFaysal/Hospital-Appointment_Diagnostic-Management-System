...
class ApiEndpoints {
  ...
  static String doctorAppointments(int id) => '/admin-auth/doctors/$id/appointments';
  static const String DOCTORS_WITH_APPOINTMENTS = '/admin-auth/doctors-with-appointments';

  // Diagnostics
  static const String DIAGNOSTICS = '/admin-auth/diagnostics';
  static String diagnosticById(int id) => '/admin-auth/diagnostics/$id';
  static String diagnosticStatus(int id) => '/admin-auth/diagnostics/$id/status';
  ...
  static String appointmentCancel(int id) => '/admin-auth/appointments/$id/cancel';
  static String appointmentReassign(int id) => '/admin-auth/appointments/$id/reassign';
  static const String APPOINTMENTS_BULK_STATUS = '/admin-auth/appointments/bulk-status';

  // Diagnostic Bookings
  static const String DIAGNOSTIC_BOOKINGS = '/admin-auth/diagnostic-bookings';
  static String diagnosticBookingById(int id) => '/admin-auth/diagnostic-bookings/$id';
  static String diagnosticBookingCancel(int id) => '/admin-auth/diagnostic-bookings/$id/cancel';
  static const String DIAGNOSTIC_BOOKINGS_BULK_STATUS = '/admin-auth/diagnostic-bookings/bulk-status';
  ...
  // Role Management
  static String assignRole(int adminId) => '/admin-auth/admins/$adminId/assign-role';
  ...
  static String rolePermissions(String role) => '/admin-auth/roles/$role/permissions';
}